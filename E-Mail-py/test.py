...
def sendEmail(from_addr,password,to_addr,smtp_server):
    try:
        ...
        # msg = MIMEText('<html><body><h1>你好</h1>' + '<p>send by <a href="http://www.python.org">信息化工程所</a>...</p>' +'</body></html>', 'html', 'utf-8') # 网页文件
...
if __name__ == '__main__':
    from_addr = 'webmaster@tccxfw.com'   # 邮箱登录用户名
    password  = 'TCCxfw123'              # 登录密码
    to_addr   = ['1938036263@qq.com','jason123@vip.qq.com','jason19905@126.com'
]      # 发送对象地址，可以多个邮箱
    smtp_server='172.16.254.45'          # 服务器地址，默认端口号25
